...
//! different API from `rustyguard_aws_lc::aead` because the construct cannot use the same
//! API as `rustyguard_aws_lc::aead` due to the way the construct handles the encrypted
//! packet length.
//!
